    ...
    >
      ...
      <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1 }}>
        <Box sx={{ textAlign: 'center' }}>
          ...
          <Box sx={{ position: 'relative', mb: 4, minHeight: { xs: '120px', md: '200px' } }}>
            {/* Normal 404 - glitch sırasında gizlenir */}
            <Typography
              variant="h1"
              sx={{
            ...
            {/* Glitch efektleri - sadece glitch aktifken görünür, 404 yazısının yerinde titreme efekti */}
            {glitchActive && (
              <>
                <Typography
                  variant="h1"
          ...
          <Box sx={{ mb: 4 }}>
            ...
            >
              ...
              Maybe it's lost in the digital void.
            </Typography>
          </Box>
